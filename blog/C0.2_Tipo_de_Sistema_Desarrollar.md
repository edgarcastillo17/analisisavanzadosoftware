...
1. Apoyado de la información mostrada por el asesor, realice una investigación, donde se pueda dar respuesta a los siguientes puntos:
  ...
  ***Aplicaciones interactivas basadas en transacción*** porque como lo dice su definición puede tratarse de una aplicación web a la que se accede remotamente a servicios almacenados en la nube, al tratarse de una serie de cursos a los que los usuarios se suscribirán, cursarán, acreditarán y recibirán un certificado desde sus propias computadoras; entra en esta categoría.
  
  - Describa las características que debe tener el caso de estudio para cumplir con el tipo de sistema.

    * Tratarse de un servicio web.
    * Ser accedido de forma remota.
    * Hacer uso de contenido multimedia para los cursos.
    * Registro de usuarios con su correo electrónico.
    * Mantenerse actualizado por medio de transacciones.
  ...
  ![Diagrama](https://raw.githubusercontent.com/edgarcastillo17/avscastillo/main/diagrams/C0.2.FlujoInteraccion.png "Diagrama de Caso de Estudio")
